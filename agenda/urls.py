...
from .views import (
    ...
    MaterialDivulgacaoEventoUpdateView,
...
urlpatterns = [
    ...
    path("materiais/novo/", MaterialDivulgacaoEventoCreateView.as_view(), name="material_criar"),
    path(
        "materiais/<int:pk>/editar/",
        MaterialDivulgacaoEventoUpdateView.as_view(),
