...
def test_material_aprovar_devolver(api_client: APIClient) -> None:
    ...
    url_aprovar = reverse("eventos_api:material-aprovar", args=[material.pk])
    ...
    url_devolver = reverse("eventos_api:material-devolver", args=[material.pk])
...
def test_material_devolver_exige_motivo(api_client: APIClient) -> None:
    ...
    api_client.force_authenticate(user)
    url = reverse("eventos_api:material-devolver", args=[material.pk])
