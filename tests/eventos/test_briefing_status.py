...
def test_aprovar_briefing(client):
    ...
    url = reverse("eventos:briefing_status", args=[briefing.pk, "aprovado"])
...
def test_orcamentar_briefing(client):
    ...
    url = reverse("eventos:briefing_status", args=[briefing.pk, "orcamentado"])
...
def test_recusar_briefing_com_motivo(client):
    ...
    url = reverse("eventos:briefing_status", args=[briefing.pk, "recusado"])
