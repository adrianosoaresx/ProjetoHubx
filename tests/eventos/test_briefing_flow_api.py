...
def test_briefing_orcamentar(api_client: APIClient) -> None:
    ...
    url = reverse("eventos_api:briefing-orcamentar", args=[briefing.pk])
...
def test_briefing_aprovar(api_client: APIClient) -> None:
    ...
    api_client.force_authenticate(user)
    url = reverse("eventos_api:briefing-aprovar", args=[briefing.pk])
...
def test_briefing_recusar(api_client: APIClient) -> None:
    ...
    api_client.force_authenticate(user)
    url = reverse("eventos_api:briefing-recusar", args=[briefing.pk])
    motivo = "Sem verba"
