...
def test_get_user_preferences_returns_global(admin_user):
    cache.clear()
    admin_user.configuracao.tema = "escuro"
    admin_user.configuracao.save(update_fields=["tema"])
    prefs = get_user_preferences(admin_user)
