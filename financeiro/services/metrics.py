...
financeiro_cobrancas_total = Counter("financeiro_cobrancas_total", "Cobranças recorrentes criadas")

# Novas métricas de observabilidade do módulo financeiro
financeiro_importacoes_total = Counter("financeiro_importacoes_total", "Total de importações iniciadas")
financeiro_importacoes_erros_total = Counter(
    "financeiro_importacoes_erros_total",
    "Total de importações concluídas com erros",
)
financeiro_relatorios_total = Counter("financeiro_relatorios_total", "Número de relatórios gerados")
financeiro_tasks_total = Counter("financeiro_tasks_total", "Execuções de tarefas Celery do módulo")
