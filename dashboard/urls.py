...
urlpatterns = [
    ...
    path("search/organizacoes/", views.organizacoes_search, name="search-organizacoes"),
    path("search/nucleos/", views.nucleos_search, name="search-nucleos"),
    path("search/eventos/", views.eventos_search, name="search-eventos"),
