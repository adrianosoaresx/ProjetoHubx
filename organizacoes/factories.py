...
class OrganizacaoFactory(DjangoModelFactory):
    ...
    codigo_banco = factory.Faker("bothify", text="###")
    nome_banco = factory.Faker("company", locale="pt_BR")
    agencia = factory.Faker("bothify", text="####")
    conta_corrente = factory.Faker("bothify", text="#########-#")
